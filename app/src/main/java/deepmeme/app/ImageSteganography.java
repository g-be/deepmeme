...
public class ImageSteganography {
    ...
    private static String encryptMessage(String message, String secret_key) {
        ...
        if (message != null) {
            if (!stegoCrypto.isStringEmpty(secret_key)) {
                try {
                    encrypted_message = stegoCrypto.encryptMessage(message, secret_key);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } else {
    ...
    public static String decryptMessage(String message, String secret_key) {
        ...
        if (message != null) {
            if (!stegoCrypto.isStringEmpty(secret_key)) {
                try {
                    decrypted_message = stegoCrypto.decryptMessage(message, secret_key);
                } catch (Exception e) {
